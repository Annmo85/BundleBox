<?php
	...
	$title = "Оплата доставки заказов ".implode(" ,",$ids1);
	if (isset($_GET['deal_id'])) {
		$title = "Оплата доставки заказа ".implode(" ,",$ids1);
	}
...
<body>
	...
	payments.pay("charge", {
		publicId: "pk_749dad9bfa66eb7a695a9ab122813",
